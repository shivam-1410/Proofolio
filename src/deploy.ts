/**
 * ============================================================================
 * Deploy Script: ZK Proof-of-Reserves to Midnight Preview Network
 * ============================================================================
 */
...
async function main() {
  console.log('\n╔══════════════════════════════════════════════════════════════╗');
  console.log(`║  Deploy ZK Proof-of-Reserves to ${network}`);
  console.log('╚══════════════════════════════════════════════════════════════╝\n');
  ...
  if (balance === 0n) {
    console.error('❌ Wallet has 0 balance. Please fund before deploying.');
  ...
  if (dustState.dust.balance(new Date()) === 0n) {
    ...
    try {
      ...
      console.log('\n  ❌ No DUST generated within timeout.\n');
      await walletCtx.wallet.stop();
      process.exit(1);
    }
  }
  ...
  if (!proofServerReady) {
    console.log('\n  ❌ Proof server not responding. Run: docker run -d --name proof-server -p 6300:6300 midnightntwrk/proof-server:8.1.0 midnight-proof-server -v\n');
    await walletCtx.wallet.stop();
    process.exit(1);
  }
  ...
  console.log('  Deploying ZK Proof-of-Reserves contract...\n');
  ...
  console.log('\n================================================================');
  console.log('  🎉 PROOF-OF-RESERVES CONTRACT DEPLOYED SUCCESSFULLY!');
  console.log('================================================================');
  console.log(`\n  PROOF-OF-RESERVES ADDRESS: ${contractAddress}`);
  console.log(`  DEPLOYER ADDRESS:          ${address}`);
  console.log(`  NETWORK:                   ${network}`);
  console.log(`  TRANSACTION HASH:          ${deployed.deployTxData.public.txHash}`);
  console.log(`  BLOCK HEIGHT:              ${deployed.deployTxData.public.blockHeight ?? 'Pending'}\n`);
