...
```text
Hey everyone! 👋 Just launched Proofolio on Midnight Preprod—a confidential Proof-of-Reserves dApp that mathematically certifies exchange/custodian solvency (reserves >= liabilities) without revealing balance sheets or customer numbers! 🛡️
...
👉 https://shivam-1410.github.io/Proofolio/ 🛡️⚡
```
...
If you have 2 minutes to test it out (works with Lace wallet or instant demo mode), let me know your wallet address so I can feature you in our official preprod tester registry. Thanks a ton! 🙌
```
...
```text
Announcing Proofolio: Confidential Solvency & Proof-of-Reserves built on @MidnightNtwrk 🛡️
