...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      incrementWithAssert: (...args_1) => {
        if (args_1.length !== 3) {
          throw new __compactRuntime.CompactError(`incrementWithAssert: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const amount_0 = args_1[1];
        const salt_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('incrementWithAssert',
                                     'argument 1 (as invoked from Typescript)',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(amount_0).concat(_descriptor_1.toValue(salt_0)),
        ...
        const result_0 = this._incrementWithAssert_0(context,
                                                     partialProofData,
                                                     amount_0,
                                                     salt_0);
        partialProofData.output = { value: [], alignment: [] };
    ...
    this.impureCircuits = {
      ...
      incrementWithAssert: this.circuits.incrementWithAssert,
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('incrementWithAssert', new __compactRuntime.ContractOperation());
  ...
  _increment_0(context, partialProofData, amount_0) {
    const tmp_0 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('counter.compact line 13 char 22: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
  ...
  _incrementWithAssert_0(context, partialProofData, amount_0, salt_0) {
    __compactRuntime.assert(amount_0 > 0n, 'Amount must be greater than zero');
    const tmp_0 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('counter.compact line 22 char 22: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
                  })(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                               partialProofData,
